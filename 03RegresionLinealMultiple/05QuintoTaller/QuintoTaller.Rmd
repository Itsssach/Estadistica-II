...
\begin{enumerate}
\item Use el método de selección \textit{'Forward'} para determinar el mejor modelo (paso por paso) y compárelo con el resultado dado por el método \textit{'Backward'} y \textit{'Stepwise'}. \textbf{Emplee el conjunto de datos del taller anterior.}
